...
function geTotalPayment(){
	...
	document.querySelector("input[name='orderTotalPayment']").value = parseInt(totalPrice-totalPoint-totalCoupon+totalDelivery)+"원";
}
			...
			<div class="order__detail">
				...
				<div class="order__right">
					...
					<div class="order__info2">
						...
						<div>
							상품금액 :
							<input class="inputBox" type="text" name="orderTotalPrice" 
							value="<fmt:formatNumber value='${total_price}' pattern="#,###" />원" readonly>
						</div>
						<div>
							상품수량 : 
							<input class="inputBox" type="text" name="orderTotalAmount"
							value="<fmt:formatNumber value='${total_amount2 }' pattern="#,###" />개" readonly> 
						</div>
						<div>
							배송비 :
							<input class="inputBox" type="text" name="orderTotalDelivery" 
							value="<fmt:formatNumber value='${total_delivery}' pattern="#,###" />원" readonly>
						</div>
						<div>
							쿠폰할인:
							<input class="inputBox" type="text" name="orderTotalCoupon" 
							value="<fmt:formatNumber value='0' pattern="#,###" />원" readonly>
						</div>
						<div>
							적립금사용 :
							<input class="inputBox" type="text" name="orderTotalPoint" 
							value="<fmt:formatNumber value='0' pattern="#,###" />원" readonly>
						</div>
						<div>
							<span class="credit">신용카드</span>
							<input class="inputBox" type="text" name="orderTotalPayment" 
							value="<fmt:formatNumber value='${total_price + total_delivery }' pattern="#,###" />원" readonly>
						</div>
					</div>
				</div>
			</div>
