...
<title>Insert title here</title>
	...
	<script>
		$(function(){
			...
			//색상 선택시 테두리적용
			test4=$("#colorsearch .color");
			$("#colorsearch .color").click(function(){
				n=test4.index(this);
				$("#colorsearch .color").eq(n).css("opacity","0.4");
				$("#colorsearch .color").eq(n).text("v");
			});
		});
		//cart테이블에 상춤추가
...
<body>
	<section>
			...
			<form name="sform" method="post" action="product_search">
				...
				<div id="pricesearch">
					...
					<div id="pricebox">
						...
						<input type="button" value="적용" onclick="go_price()" id="price_btn">
					</div>
				</div>
				<div class="ctitle">색상<input type="reset" value="초기화" id="reset_btn"></div>
				<div id="colorsearch">
					<div class="color" id="red" onclick="location='product_search?color=red&keyword=${keyword}'"></div>
					<div class="color" id="burgundy" onclick="location='product_search?color=burgundy&keyword=${keyword}'"></div>
					<div class="color" id="pink" onclick="location='product_search?color=pink&keyword=${keyword}'"></div>
					<div class="color" id="orange" onclick="location='product_search?color=orange&keyword=${keyword}'"></div>
					<div class="color" id="yellow" onclick="location='product_search?color=yellow&keyword=${keyword}'"></div>
					<div class="color" id="ivory" onclick="location='product_search?color=ivory&keyword=${keyword}'"></div>
					<div class="color" id="beige" onclick="location='product_search?color=beige&keyword=${keyword}'"></div>
					<div class="color" id="oatmeal" onclick="location='product_search?color=oatmeal&keyword=${keyword}'"></div>
					<div class="color" id="mustard" onclick="location='product_search?color=mustard&keyword=${keyword}'"></div>
					<div class="color" id="melange" onclick="location='product_search?color=melange&keyword=${keyword}'"></div>
					<div class="color" id="white" onclick="location='product_search?color=white&keyword=${keyword}'"></div>
					<div class="color" id="green" onclick="location='product_search?color=green&keyword=${keyword}'"></div>
					<div class="color" id="khaki" onclick="location='product_search?color=khaki&keyword=${keyword}'"></div>
					<div class="color" id="olive" onclick="location='product_search?color=olive&keyword=${keyword}'"></div>
					<div class="color" id="blue" onclick="location='product_search?color=blue&keyword=${keyword}'"></div>
					<div class="color" id="navy" onclick="location='product_search?color=navy&keyword=${keyword}'"></div>
					<div class="color" id="lilac" onclick="location='product_search?color=lilac&keyword=${keyword}'"></div>
					<div class="color" id="purple" onclick="location='product_search?color=purple&keyword=${keyword}'"></div>
					<div class="color" id="violet" onclick="location='product_search?color=violet&keyword=${keyword}'"></div>
					<div class="color" id="black" onclick="location='product_search?color=black&keyword=${keyword}'"></div>
					<div class="color" id="grey" onclick="location='product_search?color=grey&keyword=${keyword}'"></div>
					<div class="color" id="charcoal" onclick="location='product_search?color=charcoal&keyword=${keyword}'"></div>
					<div class="color" id="brown" onclick="location='product_search?color=brown&keyword=${keyword}'"></div>
					<div class="color" id="denim" onclick="location='product_search?color=denim&keyword=${keyword}'"></div>
				</div>
			</form>
		</div>
		...
		<div id="product">
			...
			<table id="list_table">
				<tr>
				<c:forEach items="${search_list}" var="pvo" varStatus="sts">
					<td>
						<div class="img_box">
			...
			<div id="paging">
				...
				<c:if test="${pstart!=1}">
					<a href="product_search?page=${pstart-1}&rnum=${rnum}&keyword=${keyword}&color=${color}&sprice=${sprice}&eprice=${eprice}">
						<span class="material-symbols-rounded">arrow_back</span>
					</a>
				</c:if>
				<c:forEach begin="${pstart}" end="${pend}" var="i">
					<c:if test="${page==i}">
						<a href="product_search?page=${i}&rnum=${rnum}&keyword=${keyword}&color=${color}&sprice=${sprice}&eprice=${eprice}" style="color:#000000;">${i}</a>
					</c:if>
					<c:if test="${page!=i}">
						<a href="product_search?page=${i}&rnum=${rnum}&keyword=${keyword}&color=${color}&sprice=${sprice}&eprice=${eprice}" style="color:#CCCCCC;">${i}</a>
					</c:if>
				</c:forEach>
				<c:if test="${pend!=total}">
					<a href="product_search?page=${pend+1}&rnum=${rnum}&keyword=${keyword}&color=${color}&sprice=${sprice}&eprice=${eprice}">
